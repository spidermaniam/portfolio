...
export const SkeletonHandLoader: React.FC = () => {
  return (
    <div className="flex flex-col items-center w-[220px]">
      ...
      <svg viewBox="0 0 320 280" className="w-[220px] h-auto" xmlns="http://www.w3.org/2000/svg">
        ...
        <g className="animate-palm" style={{ transformOrigin: '160px 200px' }}>
          ...
          <g id="index-finger">
            ...
            <g className="animate-index-proximal bone-segment" style={{ transformOrigin: '100px 158px' }}>
              <path d="M85 118 Q85 115 88 115 L112 115 Q115 115 115 118 L115 156 Q115 158 112 158 L88 158 Q85 158 85 156 Z" 
                    fill="url(#boneShade)" stroke="#2a2a2a" strokeWidth="1" strokeOpacity="0.7" vectorEffect="non-scaling-stroke" />
            </g>
          ...
          <g id="palm-bones">
            ...
            <path d="M30 165 Q30 160 35 160 L120 160 Q125 160 125 165 L125 255 Q125 260 120 260 L35 260 Q30 260 30 255 Z" 
                  fill="url(#palmShade)" stroke="#2a2a2a" strokeWidth="1" strokeOpacity="0.7" vectorEffect="non-scaling-stroke" />
            
            {/* Additional palm segment for depth */}
            <path d="M120 160 Q125 160 125 165 L125 255 Q125 260 120 260 L200 260 Q205 260 205 255 L205 175 Q205 170 200 170 L125 170 Q120 170 120 165 Z" 
                  fill="url(#palmShade)" stroke="#2a2a2a" strokeWidth="1" strokeOpacity="0.7" vectorEffect="non-scaling-stroke" />
            ...
            <path d="M85 160 Q87 160 87 162 L87 250 Q87 252 85 252 Q83 252 83 250 L83 162 Q83 160 85 160 Z" 
                  fill="#c0c0c0" stroke="#2a2a2a" strokeWidth="0.5" strokeOpacity="0.5" vectorEffect="non-scaling-stroke" />
            <path d="M105 160 Q107 160 107 162 L107 248 Q107 250 105 250 Q103 250 103 248 L103 162 Q103 160 105 160 Z" 
                  fill="#c0c0c0" stroke="#2a2a2a" strokeWidth="0.5" strokeOpacity="0.5" vectorEffect="non-scaling-stroke" />
            
            {/* Wrist connection */}
            <path d="M40 260 Q40 258 42 258 L195 258 Q197 258 197 260 L197 275 Q197 277 195 277 L42 277 Q40 277 40 275 Z" 
                  fill="url(#palmShade)" stroke="#2a2a2a" strokeWidth="1" strokeOpacity="0.7" vectorEffect="non-scaling-stroke" />
          </g>
